...
import { RadialGlow, ScrollGlow } from '@/components/animations/RadialGlow';
    ...
    <div>
      ...
      <main className="min-h-screen pt-16">
        ...
        <section className="relative overflow-hidden py-32 sm:py-40 lg:py-48">
          {/* Enhanced radial gradient glow effect */}
          <RadialGlow color="primary" intensity="high" size="xl" position="top" />
            ...
            <div className="mx-auto max-w-4xl text-center">
              ...
              <FadeIn delay={0.2}>
                <h1 className="mb-6 text-5xl font-normal tracking-tight sm:text-6xl lg:text-7xl">
                  We Ship Apps, Websites, SaaS & Everything In Between
                </h1>
              </FadeIn>
        ...
        <section className="relative py-20 lg:py-32">
          <RadialGlow color="purple" intensity="low" size="lg" position="top-right" />
        ...
        {/* Solution Section */}
        <section className="relative py-20 lg:py-32">
          <RadialGlow color="cyan" intensity="low" size="md" position="bottom-left" />
        ...
        <section id="how-it-works" className="relative py-20 lg:py-32">
          <RadialGlow color="mixed" intensity="low" size="lg" position="center" />
        ...
        {/* What You Get */}
        <section className="relative py-20 lg:py-32">
          <RadialGlow color="primary" intensity="low" size="md" position="top-left" />
        ...
        <section id="pricing" className="relative py-20 lg:py-32">
          {/* Enhanced radial gradient glow effect */}
          <RadialGlow color="primary" intensity="high" size="xl" position="center" />
        ...
        {/* FAQ */}
        <section className="relative py-20 lg:py-32">
          <RadialGlow color="cyan" intensity="low" size="md" position="top-right" />
